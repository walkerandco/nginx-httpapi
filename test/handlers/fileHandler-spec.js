...
let file = require('/home/swr/git/nginx-httpapi/lib/handlers/fileHandler.js');
...
describe('fileHandler class', () => {
  describe('fileHandler readConfig function', () => {
    it('should read nginx conf file', async () => {
      try {
        let out = await  file.readConfig('/home/swr/git/nginx-httpapi/test/res/nginx.conf');
  ...
  describe('fileHandler writeConfig function', () => {
    it('should return true for a write operation', async () => {
      try {
        let out = await file.readConfig('/home/swr/git/nginx-httpapi/test/res/nginx.conf');
        let truth = await file.writeConfig('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test', out);
    ...
    it('should read in a value of "nginx"', async () => {
      try {
        let out = await file.readConfig('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
  ...
  describe('checkExists function', () => {
    ...
    it('should return 1 if file exists', async () => {
      let out = await file.checkExists('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });
  });
  ...
  describe('checkPermissions function', () => {
    it('should return error for --x', async () => {
      let out = await file.checkPermissions('/home/swr/git/nginx-httpapi/test/res/perm.conf');
      expect(out).to.eql("EACCES");
    });

    it('should return 1 for rw- permissions', async () => {
      let out = await file.checkPermissions('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });
  });
  ...
  describe('fixPermissions function', () => {
    it('should successfully change permissions', async () => {
      let out = await file.fixPermissions('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });
  });
  ...
  describe('checkPermissions function', () => {
    it('should return 1 if permissions are correct', async () => {
      let out = await file.checkOwner('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });

    it('should return 0 if permissions are incorrect', async () => {
      let out = await file.checkOwner('/home/swr/git/nginx-httpapi/test/res/perm.conf');
      expect(out).to.eql(0);
    });
  });
  ...
  describe('checkCRC function', () => {
    it('should return success for matched CRC', async () => {
      let out = await file.checkCRC('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });

    it('should return an error for unmatched CRC', async () => {
      let out = await file.checkCRC('/home/swr/git/nginx-httpapi/test/res/nginx.conf');
      expect(out).to.eql(0);
    });
  ...
  describe('setCRC function', () => {
    it('should sucessfully calculate and write crc', async () => {
      let out = await file.setCRC('/home/swr/git/nginx-httpapi/test/res/nginx.conf.test');
      expect(out).to.eql(1);
    });
  });
});
